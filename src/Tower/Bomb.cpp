...
Bomb::Bomb() {
	level = 1;
	level_1 = (TowerData){1.0f, 20, 3, 300.f, 2000, 200.f, 0,  70, 0, "./gfx/tower/tower-bomb-lvl1.png", "./gfx/tower/cannon-bomb.png"};
	level_2 = (TowerData){1.5f, 35, 3, 350.f, 1800, 250.f, 0, 400, 0, "./gfx/tower/tower-bomb-lvl2.png", "./gfx/tower/cannon-bomb.png"};
